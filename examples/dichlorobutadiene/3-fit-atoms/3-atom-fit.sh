...
WORKDIR=$ROOT/examples/water/3-fit-atoms
BINDIR=$ROOT/bin
REFDIR=$ROOT/ref
MTPDIR=$ROOT/examples/water/2-mtp-fit
# INPUT
PCUBE=/data/boittier/energies/h2o_geom.xyz.dir/h2o_1.chk.fchk.potential.cube # not really used here
...
MAXCHG=3      # max charges per atom to fit (4 is usually enough for l=2 quality)
