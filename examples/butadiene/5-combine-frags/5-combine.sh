...
EXAMPLE=butadiene
WORKDIR=$ROOT/examples/$EXAMPLE/5-combine-frags
BINDIR=$ROOT/bin
FRAGDIR=$ROOT/examples/$EXAMPLE/4-fit-frags # folder containing fitted fragments
# FITTING PARAMETERS
...
MINFRAGCHGS=5       #minimum charges used to fit fragments in previous step
MAXFRAGCHGS=10      #maximum charges used to fit fragments in previous step
