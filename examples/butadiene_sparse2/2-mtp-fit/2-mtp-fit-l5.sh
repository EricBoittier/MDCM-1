...
EXAMPLE=butadiene_sparse2
WORKDIR=$ROOT/examples/$EXAMPLE/2-mtp-fit
BINDIR=$ROOT/bin
REFDIR=/data/boittier/gaussian_scans/butadiene
# INPUT
PCUBE=$REFDIR/scan_extract_0.2.pot.cube # Generated in step 1
DCUBE=$REFDIR/scan_extract_0.2.den.cube # Supplied by user (see step 1)
# OUTPUT
