...
WORKDIR=$ROOTDIR/examples/water/4-fit-frags
BINDIR=$ROOTDIR/bin
REFDIR=$ROOTDIR/ref
ATOMDIR=$ROOTDIR/examples/water/3-fit-atoms
# INPUT
MTPFILE=$ROOTDIR/examples/water/2-mtp-fit/fitted-mtpl.dat # from step 2
PCUBE=/data/boittier/energies/h2o_geom.xyz.dir/h2o_1.chk.fchk.potential.cube # again, not really used
